...
<div id="wrapper" style="opacity:0">
        ...
        <div id="page-wrapper" style="margin:0 0 0 0;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-center">Akun Anda Gagal Diaktifkan.<br/>Token Registrasi Tidak Ditemukan</h1>
                    <div class="text-center" style="padding-bottom: 20px;"><img src="<?php echo site_url('assets/img/failed.png') ?>" style="width:100px"></div>
