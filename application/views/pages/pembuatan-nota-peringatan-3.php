...
<div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            <a href="#" class="hitam"><i class="fa fa-tasks fa-fw"></i> Nota Peringatan III<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Halaman Pembuatan Nota Peringatan III</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="petugas_1" id="petugas_1" placeholder="Ketik Nama Petugas Pengawas" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="petugas_2" id="petugas_2" placeholder="Ketik Nama Petugas Pengawas" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="petugas_3" id="petugas_3" placeholder="Ketik Nama Petugas Pengawas" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="nama_perusahaan" id="nama_perusahaan" placeholder="Ketik Nama Perusahaan" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-1">&nbsp;</div>
                                    <div class="col-sm-3">
                                        <label for="hasil_temuan">Hasil Temuan</label>
                                    </div>
                                    <div class="col-sm-6">
                                        <input class="form-control" name="hasil_temuan" id="hasil_temuan" placeholder="Ketik Hasil Temuan" />
                                    </div>
                                </div>
                            </div>
