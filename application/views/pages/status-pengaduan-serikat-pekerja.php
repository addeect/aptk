...
<div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level collapse in" aria-expanded="true">
                                <li>
                                    <a href="<?php echo site_url('main/index/status-pengaduan') ?>">Tenaga Kerja</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Halaman Status Pengaduan Serikat Pekerja</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="color: #fff;background-color: #ec6b4d;">
                            Form Status Pengaduan Serikat Pekerja (Informasi sampai dimana kasus terselesaikan)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="nama" id="nama" placeholder="Ketik Nama Serikat Pekerja" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div style="width:100%;position:relative;float:left;">
                                            <p class="help-block">45% Complete</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
