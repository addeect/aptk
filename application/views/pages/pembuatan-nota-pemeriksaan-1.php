...
<div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            <a href="#" class="hitam"><i class="fa fa-tasks fa-fw"></i> Nota Pemeriksaan I<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Halaman Pembuatan Nota Pemeriksaan I</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
