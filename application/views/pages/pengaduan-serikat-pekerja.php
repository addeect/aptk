...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background: linear-gradient(154deg,#ef4949 0,#e89752 100%);">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle putih" data-toggle="dropdown" href="#">
                        <?php echo ucfirst($_SESSION['role']) ?> - <?php echo $_SESSION['nama_user'] ?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            <a href="#" class="hitam"><i class="fa fa-files-o fa-fw"></i> Jenis Pengaduan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse in" aria-expanded="true">
                                <li>
                                    <a href="<?php echo site_url('main/index/pengaduan-tenaga-kerja') ?>">Tenaga Kerja</a>
                                </li>
                                <li>
                                    <a class="aktif" >Serikat Pekerja</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Halaman Pengaduan Serikat Pekerja</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="color: #fff;background-color: #ec6b4d;">
                            Form Pengaduan Serikat Pekerja (Input Data Keluhan)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-1">&nbsp;</div>
                                    <div class="col-sm-3">
                                        <label for="nama">Nama Serikat Pekerja</label>
                                    </div>
                                    <div class="col-sm-6">
                                        <input class="form-control" name="nama" id="nama" placeholder="Ketik Nama Anda" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="nama_perusahaan" id="nama_perusahaan" placeholder="Ketik Nama Perusahaan Tempat Anda Bekerja" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="jenis_usaha" id="jenis_usaha" placeholder="Ketik Jenis Usaha" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="alamat_perusahaan" id="alamat_perusahaan" placeholder="Ketik Alamat Tempat Anda Bekerja" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="jenis_keluhan" class="form-control" id="jenis_keluhan">
                                            ...
                                            <option value="A">Keluhan A</option>
                                            <option value="B">Keluhan B</option>
                                            <option value="C">Keluhan C</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea style="resize:none;height:200px" class="form-control" name="keluhan" id="keluhan" placeholder="Ketik Keluhan Anda"/></textarea>
                                    </div>
                                </div>
                            </div>
