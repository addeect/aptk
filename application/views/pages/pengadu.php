<div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level collapse in" aria-expanded="true">
                                <li>
                                    <a href="<?php echo site_url('main/index/pengguna') ?>" >Pengguna</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Master Pengadu</h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>0701001</td>
                                        <td>Supriyadi</td>
                                        <td>Sidoarjo, 30 April 1977</td>
                                        <td>Laki-laki</td>
                                        <td>Jl. Seram HOP No.10 Surabaya</td>
                                        <td>Islam</td>
                                        <td>Kawin</td>
                                        <td>******</td>
                                        <td><a href="<?php echo site_url('main/index/edit-pengadu') ?>?nik=0701001" class="btn btn-sm btn-warning">Edit</a></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>0701002</td>
                                        <td>Setyadi</td>
                                        <td>Jakarta, 12 Oktober 1980</td>
                                        <td>Laki-laki</td>
                                        <td>Jl. Belibis 3 No.9 GGA Gresik</td>
                                        <td>Kristen</td>
                                        <td>Kawin</td>
                                        <td>******</td>
                                        <td><a href="<?php echo site_url('main/index/edit-pengadu') ?>?nik=0701002" class="btn btn-sm btn-warning">Edit</a></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>0701003</td>
                                        <td>Eka Putri</td>
                                        <td>Tulungagung, 5 Mei 1983</td>
                                        <td>Perempuan</td>
                                        <td>Jl. Baruk Utara 3 No.55 Surabaya</td>
                                        <td>Islam</td>
                                        <td>Belum Kawin</td>
                                        <td>******</td>
                                        <td><a href="<?php echo site_url('main/index/edit-pengadu') ?>?nik=0701003" class="btn btn-sm btn-warning">Edit</a></td>
                                    </tr>
                                </tbody>
                            </table>
                            <!-- /.table-responsive -->
